...
<br><br><br><br>
         ...
         <h3>Basic Info:</h3>
            ...
            <form:input path="username" placeholder="Username" id="username" type="text" class="form-Control" />
       
            <form:errors path="password" cssStyle="color: #ff0000" />
            <form:input path="password" placeholder="Password" id="password" type="password" class="form-Control" />
        <br/>
