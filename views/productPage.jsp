...
<!-- products-breadcrumb -->
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="indel">Home</a><span>|</span></li>
...
<%-- 					<img id="example" src="${img}/office/desk accesories/149.png" alt=" " class="img-responsive" /> --%>
				<c:url value="/resources/IMGS/${productObj.productId }.png" var="src" />
				</div>
...
<%-- 						${productObj.productdesc} --%>
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4>$21.00 <%-- ${productObj.selling_price } --%><span><%-- ${productObj.prize } --%>$25.00</span></h4>
						</div>
